...
// Definimos el tipo Icon para asegurar que los valores son JSX.Element
type Icon = {
	support: JSX.Element;
	damage: JSX.Element;
	tank: JSX.Element;
...
// Creamos el objeto icon con los iconos SVG correspondientes
const icon: Icon = {
	support: (
...
export const HeroeCard: React.FC<Props> = ({ id, name, portrait, role }) => {
	return (
		<Link
			href={`/heroes/${id}`}
			className="flex flex-col bg-white p-0.5 rounded-sm items-center hover:scale-105 xl:hover:scale-[1.15] hover:transform hover:duration-300 hover:ease-in-out transition-transform h-[235px] md:p-1 md:h-[321px] lg:w-[208px] xl:h-[290px] xl:w-[196px]"
		>
			<div className="flex overflow-hidden w-full h-full bg-blue-100">
				<Image
					className="overflow-hidden object-cover scale-[1.02]"
					src={portrait}
					alt={name}
					width={210}
					height={210}
